"""ZeroClick AI-native ad integration for The Oracle.

Fetches contextual sponsored offers from ZeroClick's API and appends them
to marketplace search results and leaderboards. Ads are clearly labeled
...
def format_offers_text(query: str, limit: int = 2) -> str:
    """Fetch ZeroClick offers and format as text to append to results."""
