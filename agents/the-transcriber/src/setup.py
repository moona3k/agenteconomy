"""One-time setup script: registers The Transcriber agent and payment plan on Nevermined.
...
MCP_SERVER_NAME = "the-transcriber"
...
def main():
    ...
    print(f"\nRegistering The Transcriber on Nevermined ({nvm_environment})...\n")
    ...
    agent_api = AgentAPIAttributes(
        endpoints=[
            Endpoint(verb="POST", url=f"mcp://{MCP_SERVER_NAME}/tools/transcribe_youtube"),
            Endpoint(verb="POST", url=f"mcp://{MCP_SERVER_NAME}/tools/transcribe_file"),
            Endpoint(verb="POST", url=f"mcp://{MCP_SERVER_NAME}/tools/transcriber_info"),
        ],
